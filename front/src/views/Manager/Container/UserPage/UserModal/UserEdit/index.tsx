...
const UserEdit = () => {
    ...
    //          state: 회원들 상태          //
    const user = useUserPageStore(state => state.editUser!);
    //          state: 쿠키 상태                //
    ...
    //          state: 핀 가능 상태              //
    const [canPin, setCanPin] = useState<boolean>(true);
    //          state: 이름 상태              //
    const [name, setName] = useState<string>(user.name);
    //          state: 이름 초성 상태              //
    const [initialName, setInitialName] = useState<string>(user.initialName);
    //          state: 닉네임 상태              //
    const [nickname, setNickname] = useState<string>(user.nickname!);
    //          state: 닉네임 가능 상태              //
    const [canNickname, setCanNickname] = useState<boolean>(true);
    //          state: 전화번호 상태              //
    const [phoneNumber, setPhoneNumber] = useState<string>(user.phoneNumer!);
    ...
    const getChosung = (name: string): string => {
        const chosungArray = ["ㄱ", "ㄲ", "ㄴ", "ㄷ", "ㄸ", "ㄹ", "ㅁ", "ㅂ", "ㅃ", "ㅅ", "ㅆ", "ㅇ", "ㅈ", "ㅉ", "ㅊ", "ㅋ", "ㅌ", "ㅍ", "ㅎ"];
        ...
        <UserEditE>
            ...
            <InputContainer>
                ...
                <Buttons>
                    ...
                    <AddComplete onClick={onUserAddClickHandler}>회원 수정</AddComplete>
                </Buttons>
            </InputContainer>
        </UserEditE>
    )
