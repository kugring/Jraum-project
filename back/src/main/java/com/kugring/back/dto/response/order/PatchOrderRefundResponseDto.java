...
@Getter
public class PatchOrderRefundResponseDto extends ResponseDto {

  private PatchOrderRefundResponseDto() {
    super();
  }

  // 성공 응답
  public static ResponseEntity<PatchOrderRefundResponseDto> success() {
    PatchOrderRefundResponseDto result = new PatchOrderRefundResponseDto();
