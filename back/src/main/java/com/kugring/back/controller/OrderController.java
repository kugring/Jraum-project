...
public class OrderController {
  ...
  @PostMapping("")
  public ResponseEntity<? super PostOrderResponseDto> postOrder(@RequestBody @Valid PostOrderRequestDto reqeustBody) {
    ResponseEntity<? super PostOrderResponseDto> resposne = orderService.postOrderList(reqeustBody);
    return resposne;
  }
